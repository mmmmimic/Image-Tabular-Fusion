...
'''
Adapted from https://github.com/ai-med/DAFT/blob/master/daft/models/base.py 
Adapted from https://github.com/ai-med/DAFT/blob/master/daft/networks/vol_networks.py
'''
