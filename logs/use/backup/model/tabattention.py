# adapted from https://github.com/SanoScience/Tab-Attention/blob/main/src/models/tabattention.py
import torch
...
class TabAttention(nn.Module):
    def __init__(self, input_dim, tab_dim=6, tabattention=True, cam_sam=True, temporal_attention=False):
        """
