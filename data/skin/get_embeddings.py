...
def onehot_noaug():
    ...
    trainset = Skin(split='train', transforms=transforms, numerical=True, 
    ...
    trainset = Skin(split='val', transforms=transforms, numerical=True, 
                tab_embedder=OneHotEmbedder(), preload_images=False, 
                root_dir=root_dir, modal=['tab'])
    embs = get_all(trainset, batch_size=32)
    ...
    trainset = Skin(split='test', transforms=transforms, numerical=True, 
                tab_embedder=OneHotEmbedder(), preload_images=False, 
                root_dir=root_dir, modal=['tab'])
    embs = get_all(trainset, batch_size=32)
